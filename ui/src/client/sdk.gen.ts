 ...
 */
export const getCampaignLimitsApiV1OrganizationsCampaignLimitsGet = <ThrowOnError extends boolean = false>(options?: Options<GetCampaignLimitsApiV1OrganizationsCampaignLimitsGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetCampaignLimitsApiV1OrganizationsCampaignLimitsGetResponse, GetCampaignLimitsApiV1OrganizationsCampaignLimitsGetError, ThrowOnError>({
